...
pytorch_model.load_state_dict(torch.load('/Users/david/Documents/GitHub/Digit-Classification/digit-classification/models/torch_model.pth', map_location=torch.device('cpu')))
pytorch_model.eval()
